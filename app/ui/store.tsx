...
export default function Store_Item(props: any) {
    ...
    return (
        ...
        <button onClick={Pressed} className="transition bg-cyan-600 hover:bg-cyan-700 hover:-translate-y-3 hover:shadow-2xl shadow-md rounded-xl p-5 flex flex-col min-h-[350px] max-h-[350px]">
